        ...
        for board in boardlist:
            ...
            if board in ap_periph_targets:
                ...
                if 'sitl' in board or 'SITL' in board:
                    task['targets'] = ['antennatracker', 'copter','river', 'heli', 'plane', 'rover', 'sub', 'replay']
                elif 'linux' in board:
                    task['targets'] = ['antennatracker', 'copter','river', 'heli', 'plane', 'rover', 'sub']
                else:
                    task['targets'] = ['antennatracker', 'copter','river', 'heli', 'plane', 'rover', 'sub', 'bootloader']
...
for name in ('antennatracker', 'copter','river', 'heli', 'plane', 'rover', 'sub', 'blimp', 'bootloader','iofirmware','AP_Periph','replay'):
