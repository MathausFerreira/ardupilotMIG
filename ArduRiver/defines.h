...
#define WP_YAW_BEHAVIOR_LOOK_AT_NEXT_WP_EXCEPT_RTL    1   //  Mathaus --> 2 - auto pilot will face next waypoint except when doing RTL at which time it will stay in it's last
